      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
              ...
              child: SvgPicture.asset(AppIcons.message,color: Colors.black,)
          ),
        ],
      ),
      body: Padding(
                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Image.asset(listoforder[i].image,fit: BoxFit.fill,),
                            ),
                          ),
                          SizedBox(
                              ...
                              children: [
                                RichText(
                                  text: TextSpan(
                                    ...
                                    style: TextStyle(fontSize: AppTexts.size14,fontWeight:FontWeight.w500,color: Colors.black),
                                    children:  <TextSpan>[
                                      TextSpan(text: listoforder[i].location, style: TextStyle(fontWeight: FontWeight.w500,fontSize: AppTexts.size10)),
                                    ],
                                  ),
                                ),
                                Row(
                                  ...
                                  children: [
                                    Text(listoforder[i].noofproducts,
                                      style: TextStyle(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Center(
                                        child: Text(listoforder[i].status,
