...
import 'package:ecommerce_app/views/pages/CART%20&%20CHECKOUT/product_detial/productdetail.dart';
...
class StoreDetail extends StatefulWidget {
  const StoreDetail({Key? key, required this.reviews, required this.rating})
      : super(key: key);
  final int reviews;
  final double rating;
  @override
