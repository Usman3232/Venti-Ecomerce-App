...
class ChatInvoice extends StatefulWidget {
  const ChatInvoice({Key? key}) : super(key: key);

  @override
  State<ChatInvoice> createState() => _ChatInvoiceState();
}

class _ChatInvoiceState extends State<ChatInvoice> {
