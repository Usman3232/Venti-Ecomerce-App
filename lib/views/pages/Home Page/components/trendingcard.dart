...
class HomeTrendingCard extends StatefulWidget {
  HomeTrendingCard({
    Key? key,
    required this.image,
    required this.title,
  ...
  @override
  State<HomeTrendingCard> createState() => _HomeTrendingCardState();
}

class _HomeTrendingCardState extends State<HomeTrendingCard> {
  @override
